...
public final class BudgetWavePlan {
    ...
    private static Map<Theme, List<Option>> makePools() {
        ...
        EntityType<? extends Mob> spiderPig = MutantMonstersCompatibility.mobType("spider_pig");
        EntityType<? extends Mob> minion = MutantMonstersCompatibility.mobType("creeper_minion");
        EntityType<? extends Mob> mz = MutantMonstersCompatibility.mobType("mutant_zombie");
        EntityType<? extends Mob> mc = MutantMonstersCompatibility.mobType("mutant_creeper");
        EntityType<? extends Mob> ms = MutantMonstersCompatibility.mobType("mutant_skeleton");
        EntityType<? extends Mob> me = MutantMonstersCompatibility.mobType("mutant_enderman");
        pools.put(Theme.ARMORED, ALL.stream().filter(option -> option.type != InvEntities.WARDEN && option.type != spiderPig && option.type != minion).toList());
        ...
        addToPool(pools, Theme.UNDERGROUND, ms); addToPool(pools, Theme.UNDERGROUND, me);
        addToPool(pools, Theme.RANGED, ms);
        return pools;
    }
