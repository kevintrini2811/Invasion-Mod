...
public interface InvEntities {
    ...
    static void registerAttributes(EntityAttributeCreationEvent event) {
        ...
        event.put(ZOMBIE_PIGMAN_BRUTE, EntityIMZombiePigman.createT3Attributes().build());
        event.put(ZOMBIE_VILLAGER_BRUTE, EntityIMZombie.createTierT3V0Attributes().build());
        event.put(DROWNED_BRUTE, IMDrownedEntity.createAttributes().build());
        event.put(HUSK_BRUTE, EntityIMZombie.createTierT3V0Attributes().build());
        event.put(SPEEDY_ZOMBIE_BRUTE, EntityIMZombie.createTierT3V0Attributes().build());
