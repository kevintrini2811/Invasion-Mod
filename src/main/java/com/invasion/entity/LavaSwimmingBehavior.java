...
final class LavaSwimmingBehavior<T extends PathfinderMob & NexusEntity> {
    ...
    private final class LavaMoveControl extends MoveControl {
        private static final float LAVA_SPEED_MULTIPLIER = 0.5F;
        private final T swimmer = LavaSwimmingBehavior.this.mob;
        ...
        public void tick() {
            ...
            LivingEntity attackTarget = swimmer.getTarget();
            if (attackTarget != null && attackTarget.isInLava()) {
                ...
                BlockPos nexus = swimmer.getNexus().getOrigin();
            ...
            BlockPos nexusPos = swimmer.hasNexus()
                    ? swimmer.getNexus().getOrigin() : null;
            ...
            boolean climbingShore = nexusPos != null
                    && nexusPos.getY() + 0.5D > mob.getY()
                    && shoreClimbTicks-- > 0;
            if (climbingShore && swimmer.isEyeInFluid(FluidTags.LAVA)) {
                x = 0.0D;
                z = 0.0D;
            ...
            mob.setDeltaMovement(
                    ...
                    climbingShore && !swimmer.isEyeInFluid(FluidTags.LAVA)
