...
public final class IMSpiderPigEntity extends SpiderPig implements IMMutantMob {
    private final IHasNexus.Handle nexus = new IHasNexus.Handle(this::level);
    public IMSpiderPigEntity(EntityType<? extends SpiderPig> type, Level level) { super(type, level); }
