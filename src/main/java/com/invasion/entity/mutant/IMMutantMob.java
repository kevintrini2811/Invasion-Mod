...
public interface IMMutantMob
    ...
    default ResourceKey<LootTable> mutantLootTable() {
        ResourceLocation id = net.minecraft.core.registries.BuiltInRegistries.ENTITY_TYPE
                .getKey(asEntity().getType());
        return ResourceKey.create(Registries.LOOT_TABLE,
                ResourceLocation.fromNamespaceAndPath("mutantmonsters",
                        "entities/" + id.getPath()));
    }

    private static <T extends Entity & AnimatedEntity> void sendAnimationPacket(
            Entity mob,
            fuzs.mutantmonsters.world.entity.EntityAnimation animation) {
