...
public final class ImpModel extends EntityModel<ArmedEntityRenderState>
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition head = root.addOrReplaceChild(PartNames.HEAD,
                CubeListBuilder.create().texOffs(44, 0).addBox(-2.733333F, -3, -2, 5, 3, 4),
                PartPose.offsetAndRotation(-0.4F, 9.8F, -3.3F, 0.15807F, 0, 0));
        head.addOrReplaceChild("right_horn",
                CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, -1, -0.5F, 1, 1, 1),
                PartPose.offset(1.166667F, -3, 0.8F));
        head.addOrReplaceChild("left_horn",
                CubeListBuilder.create().texOffs(0, 2).addBox(-0.5F, -1, -0.5F, 1, 1, 1),
                PartPose.offset(-1.633333F, -3, 0.8F));
    ...
    public void setupAnim(ArmedEntityRenderState state) {
        ...
        float cosA = Mth.cos(state.walkAnimationPos * 0.6662F);
