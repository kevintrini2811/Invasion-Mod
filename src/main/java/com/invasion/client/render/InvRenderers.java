...
public final class InvRenderers {
    ...
    public static void bootstrap() {
        ...
        EntityRendererRegistry.register(InvEntities.ZOMBIE_BRUTE,
                context -> new InvasionZombieRenderer<>(context, false));
        EntityRendererRegistry.register(InvEntities.TAR_ZOMBIE,
                context -> new InvasionZombieRenderer<>(context, false));
        ...
        EntityRendererRegistry.register(InvEntities.GHAST, IMGhastRenderer::new);
        EntityRendererRegistry.register(
        ...
        EntityRendererRegistry.register(InvEntities.ZOMBIE_MINER,
        ...
        EntityRendererRegistry.register(InvEntities.SLIME, SlimeRenderer::new);
        EntityRendererRegistry.register(
        ...
        EntityRendererRegistry.register(InvEntities.BIG_THROWER, ThrowerRenderer::new);
