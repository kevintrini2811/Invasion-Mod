...
public class ModelBird extends HierarchicalModel<VultureEntity> {
    ...
    @Override
    public void setupAnim(VultureEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        body.xRot = 1.570796F - headPitch * Mth.DEG_TO_RAD;
        body.yRot = 0;
    }

    @Override
    public void prepareMobModel(VultureEntity entity, float limbAngle, float limbDistance, float tickDelta) {
