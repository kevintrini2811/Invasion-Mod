...
public interface InvItems {
    ...
    Item TAR_ZOMBIE_SPAWN_EGG = register("tar_zombie_spawn_egg", p -> createSpawnEgg(p, InvEntities.TAR_ZOMBIE, 0x4F5A32, 0x1E2518, NexusEntity.createVariant(2, 2)));
    Item ZOMBIE_BRUTE_SPAWN_EGG = register("zombie_brute_spawn_egg", p -> createSpawnEgg(p, InvEntities.ZOMBIE_BRUTE, 0x1E4538, 0x595D4D, NexusEntity.createVariant(0, 3)));
    Item SPEEDY_ZOMBIE_BRUTE_SPAWN_EGG = register("speedy_zombie_brute_spawn_egg",
            p -> createSpawnEgg(p, InvEntities.SPEEDY_ZOMBIE_BRUTE, 0x00B9C7, 0x102B31, NexusEntity.createVariant(0, 3)));
    Item HUSK_BRUTE_SPAWN_EGG = register("husk_brute_spawn_egg",
            p -> createSpawnEgg(p, InvEntities.HUSK_BRUTE, 0x6A5A3A, 0xD0B36A, NexusEntity.createVariant(0, 3)));
    Item DROWNED_BRUTE_SPAWN_EGG = register("drowned_brute_spawn_egg",
            p -> createSpawnEgg(p, InvEntities.DROWNED_BRUTE, 0x4A6C6D, 0x8F9A6D, NexusEntity.createVariant(0, 3)));
    Item ZOMBIE_VILLAGER_BRUTE_SPAWN_EGG = register("zombie_villager_brute_spawn_egg",
            p -> createSpawnEgg(p, InvEntities.ZOMBIE_VILLAGER_BRUTE, 0x563C33, 0x799C65, NexusEntity.createVariant(0, 3)));
    ...
    Item ZOMBIE_MINER_SPAWN_EGG = register("zombie_miner_spawn_egg", p -> createSpawnEgg(p, InvEntities.ZOMBIE_MINER, 0x4B7328, 0x55FFFF));
    Item THROWER_SPAWN_EGG = register("thrower_spawn_egg", p -> createSpawnEgg(p, InvEntities.THROWER, 0x586039, 0x06090C));
    Item BIG_THROWER_SPAWN_EGG = register("big_thrower_spawn_egg", p -> createSpawnEgg(p, InvEntities.BIG_THROWER, 0x394119, 0x181C0A, NexusEntity.createVariant(0, 2)));
    ...
    Item BREEZE_SPAWN_EGG = register("breeze_spawn_egg",
    ...
    Item SLIME_SPAWN_EGG = register("slime_spawn_egg",
            p -> createSpawnEgg(p, InvEntities.SLIME, 0x51A03E, 0x7EBF6E));
    Item MAGMA_CUBE_SPAWN_EGG = register("magma_cube_spawn_egg",
            p -> createSpawnEgg(p, InvEntities.MAGMA_CUBE, 0x340000, 0xFCFC00));
    ...
    Item ZOMBIE_PIGMAN_BRUTE_SPAWN_EGG = register("zombie_pigman_brute_spawn_egg", p -> createSpawnEgg(p, InvEntities.ZOMBIE_PIGMAN_BRUTE, 0xE6908F, 0x545627, NexusEntity.createVariant(1, 3)));
    ...
    Item MUTANT_ZOMBIE_SPAWN_EGG = registerMutantSpawnEgg("mutant_zombie", 0x799B65, 0x00AFAF);
    Item MUTANT_CREEPER_SPAWN_EGG = registerMutantSpawnEgg("mutant_creeper", 0x51943E, 0xA80A46);
    Item MUTANT_SKELETON_SPAWN_EGG = registerMutantSpawnEgg("mutant_skeleton", 0xC1C1C1, 0x604949);
    Item MUTANT_ENDERMAN_SPAWN_EGG = registerMutantSpawnEgg("mutant_enderman", 0x161616, 0x8733CC);
    Item SPIDER_PIG_SPAWN_EGG = registerMutantSpawnEgg("spider_pig", 0x343327, 0xF0A5A2);
    Item CREEPER_MINION_SPAWN_EGG = registerMutantSpawnEgg("creeper_minion", 0x51943E, 0x00AFAF);

    private static Item registerMutantSpawnEgg(String name, int primary, int secondary) {
        EntityType<? extends Mob> type = MutantMonstersCompatibility.mobType(name);
        return type == null ? null : register(name + "_spawn_egg",
                p -> createSpawnEgg(p, type, primary, secondary));
    }
