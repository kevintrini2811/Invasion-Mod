...
public interface InvItems {
    ...
    Item BIG_THROWER_SPAWN_EGG = register("big_thrower_spawn_egg", p -> createSpawnEgg(p, InvEntities.BIG_THROWER, 0x5303814, 0x632808, NexusEntity.createVariant(0, 2)));
    ...
    private static Item registerMutantSpawnEgg(String mobName,
            int primaryColor, int secondaryColor) {
        EntityType<? extends Mob> type = MutantMonstersCompatibility.mobType(mobName);
        return type == null ? null : register(mobName + "_spawn_egg",
                properties -> createSpawnEgg(properties, type,
